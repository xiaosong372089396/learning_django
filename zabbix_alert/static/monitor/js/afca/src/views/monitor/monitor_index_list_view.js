...
define(function (require, exports, module) {
    ...
    var IndexView = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            this.collection.fetchData(true, {group_status_info:true, get_event_triggers_status: true, get_top_data: true}, this, this.intervalFetch);
        },
        addAll: function () {
        ...
        intervalFetch: function (self) {
            //120秒更新一次页面数据
            setTimeout(function () {
                self.collection.fetchData(true, {group_status_info:true, get_event_triggers_status: true, get_top_data: true}, self, self.intervalFetch);
            }, 120000)
